...
<template>
  <div>
    <v-app-bar color="primary" app dark>
      ...
      <v-btn v-if="user !== null" class="mx-2" :to="{ name: 'dashboard' }">Dashboard</v-btn>

         <v-btn class="null" :to="{ name: 'track' }">Track</v-btn>
     
      <v-btn class="mx-2" :to="{ name: 'login' }">Dashboard</v-btn>
